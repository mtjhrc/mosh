...
public:
  ...
  void register_select( Select& select ) { connection->register_select( select ); }
  Actions wakeup( Select& select ) { return connection->wakeup( select ); }
